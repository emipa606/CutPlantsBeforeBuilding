...
[2021/08/04]中国語(簡体字)に対応
・中国語(簡体字)訳を追加(Juijote氏)
...
[2019/03/15]収穫できる場合は刈り取りではなく収穫の指示を送るように
・収穫できる場合は刈り取りではなく収穫の指示を送るように

[2018/10/14]1.0に対応
・1.0開発版(1.0.2056)に対応（多分正式版も動く）

[2018/09/07]B19に対応
・B19開発版(0.19.2017)に対応

[2018/08/26]B19に対応
・B19開発版(0.19.2006)に対応（正式版でも動けばいいな）

[2018/06/29]1.0に対応
・1.0開発版(1.0.1948)に対応（多分正式版も動く）
・フロアを敷くときにも自動で刈り取り指示をするように
・寝床等の工数がない建物を建築する場合、刈り取り指示をしないように
